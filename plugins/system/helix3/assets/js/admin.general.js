...
jQuery(function ($) {
  ...
  $(document).ready(function () {
        ...
        for (i = 0; i < eleclass.length; i++) {
          if ($.inArray(eleclass[i], classes) < 0) {
            ...
            if ($(parent).prop("type") == "fieldset") {
              ...
              var activeItems =
                conditionClassName + elecls + "_" + $(selected).val();
    ...
    $("#jform_template")
      ...
      .appendTo($(".form-inline.form-inline-header"));
    $("#jform_home")
      .closest(".control-group")
      .appendTo($(".form-inline.form-inline-header"));
    ...
    footerHtml +=
      '<a href="https://www.joomshaper.com/joomla-extensions" target="_blank">Joomla Extensions</a>';
    footerHtml += "</div>";
    footerHtml += "</div>";
  ...
  // clear image
  $(".helix-options .controls .field-media-wrapper .input-append").on(
    "click",
    ".button-clear",
    function (event) {
      $(this)
